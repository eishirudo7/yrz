...
// Tambahkan fungsi untuk menangani avatar tidak valid atau kosong
const getValidAvatar = (avatarUrl: string) => {
  if (!avatarUrl || avatarUrl === '') {
    return '/default-avatar.png'; // Path ke avatar default
  }
  
  // Cek jika URL sudah lengkap (dimulai dengan http atau https)
  if (avatarUrl.startsWith('http://') || avatarUrl.startsWith('https://')) {
    return avatarUrl;
  }
  
  // Tambahkan domain Shopee jika path relatif
  return `https://cf.shopee.co.id/file/${avatarUrl}`;
};
