...
import { getUserIdByShopId as getUserIdByShopIdFromDB } from '@/app/services/databaseOperations';
...
export class UserSettingsService {
  ...
  static async getUserIdFromShopId(shopId: number): Promise<string | null> {
    try {
      ...
      const dbUserId = await getUserIdByShopIdFromDB(shopId);
      ...
      await redis.set(this.getShopToUserKey(shopId), dbUserId);
