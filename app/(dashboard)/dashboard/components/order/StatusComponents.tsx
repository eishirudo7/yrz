import { Package, Clock, Truck, XCircle, AlertCircle, RefreshCcw, Send, CheckCircle } from 'lucide-react';
...
export const StatusBadge = ({ status, order, onProcess, onCancellationAction }: StatusBadgeProps) => (
